...
// releases_vn
export const releasesVn = pgTable(
  'releases_vn',
  {
    id: text('id'),
    vid: text('vid'),
...
// releases_titles
export const releasesTitles = pgTable(
  'releases_titles',
  {
    id: text('id'),
    lang: text('lang'),
...
// releases_producers
export const releasesProducers = pgTable(
  'releases_producers',
  {
    id: text('id'),
    pid: text('pid'),
...
// producers_relations
export const producersRelations = pgTable(
  'producers_relations',
  {
    id: text('id'),
    pid: text('pid'),
