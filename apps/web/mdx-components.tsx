...
export const mdxComponents: MDXComponents = {
  ...
  code: ({ children, className }) => <TypographyInlineCode>{children}</TypographyInlineCode>,
  pre: ({ children }) => (
    <pre className="rounded-lg p-4 overflow-x-auto border border-slate-200 dark:border-slate-700">{children}</pre>
  ),
  ...
  th: ({ children }) => <TypographyTableHeader>{children}</TypographyTableHeader>,
