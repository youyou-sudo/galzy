...
const commentComponents = {
  h1: ({ className, ...props }: ComponentProps<'h1'>) => (
    <h1 className={cn('text-base font-semibold mt-2 mb-1', className)} {...props} />
  ),
  h2: ({ className, ...props }: ComponentProps<'h2'>) => (
    <h2 className={cn('text-sm font-semibold mt-2 mb-1', className)} {...props} />
  ),
  h3: ({ className, ...props }: ComponentProps<'h3'>) => (
    <h3 className={cn('text-sm font-semibold mt-2 mb-1', className)} {...props} />
  ),
  h4: ({ className, ...props }: ComponentProps<'h4'>) => (
    <h4 className={cn('text-sm font-medium mt-1.5 mb-0.5', className)} {...props} />
  ),
  h5: ({ className, ...props }: ComponentProps<'h5'>) => (
    <h5 className={cn('text-sm font-medium mt-1.5 mb-0.5', className)} {...props} />
  ),
  h6: ({ className, ...props }: ComponentProps<'h6'>) => (
    <h6 className={cn('text-sm font-medium mt-1.5 mb-0.5', className)} {...props} />
  ),
  ...
  blockquote: ({ className, ...props }: ComponentProps<'blockquote'>) => (
    <blockquote
      className={cn('border-l-2 border-muted-foreground/30 pl-3 my-2 text-muted-foreground', className)}
      {...props}
    />
  ),
  ...
  img: ({ className, alt, ...props }: ComponentProps<'img'>) => (
    <img className={cn('rounded max-w-full my-1', className)} alt={alt} {...props} />
  ),
  ...
  th: ({ className, ...props }: ComponentProps<'th'>) => (
    <th className={cn('border border-border px-2 py-1 bg-muted font-medium text-left', className)} {...props} />
  ),
