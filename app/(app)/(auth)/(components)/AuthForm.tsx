...
export default function AuthForm() {
  ...
  const [signInstare, setSignInStare] = useState<any>(null);
  const [signUpstare, setSignUpStare] = useState<any>(null);
          ...
          <TabsContent value="account" className="space-y-6 p-6">
            <Form {...signInform}>
              ...
              >
                ...
                />
                {signInstare !== null && (
                  <Alert variant={signInstare.user ? "default" : "destructive"}>
