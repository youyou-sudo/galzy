...
>(({ className, ...props }, ref) => (
  <h1
    ref={ref}
    className={cn('scroll-m-20 text-2xl tracking-tight lg:text-3xl', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'mt-3 scroll-m-20 text-lg font-semibold tracking-tight',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('leading-3 not-first:mt-6', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <blockquote
    ref={ref}
    className={cn(
      'mt-6 border-l-2 pl-6 italic text-slate-700 dark:text-slate-300',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-xl text-slate-700 dark:text-slate-300', className)}
    {...props}
  />
))
